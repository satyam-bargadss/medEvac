...
<?php
     ...
     //  print_r($data['agentPaymentId']);exit;
		...
		$toataAmont =$data2[0]->feeAmount+($data['countperson']*$data2[0]->burialFee)+$data2[0]->seminarFee + $TAX;
		//echo $toataAmont;exit;
		$APILoginID  = '5uJ1aCSh55';
		$SecureTransactionKey = 'Wq60m81KdD';
		//$APILoginID =  '563b59201ed8da9f9874f246fc44b62d';
		//$SecureTransactionKey = '70c6bVDQw7';
	    //$MerchantID    = "383572";
...
function oncallback(e) {
    ...
    //  $('#send_form').html('Sending..');
      $.ajax({
		...
		// url: 'http://192.168.0.124:8000/paymentSucess' ,
        type: "get",
        data: {'customer_token':customer_token,'total_amount':total_amount,'method_used':method_used,'agentPaymentId':agentPaymentId,'burialFee':burialFee},
